...
| 2 | Code  | Lombok | Code template code | We have done too many template code and so don't need to learn that
| 3 | Dependency Management  | Grandle | Maven | Tired of XML bloat
